...
hs.hotkey.bind({ "cmd", "shift" }, "W", open_app({ "Visual Studio Code", "PhpStorm", "Webstorm", "IntelliJ IDEA" }))
...
hs.hotkey.bind({ "cmd", "shift" }, "B", open_app({ "Arc", "Google Chrome", "Brave Browser" }))
